#include "Serenade_Opportunistic.hpp"
#include <fstream>
...
int main(int argc, char* argv[]){
    ...
    std::string fn = "../results/O_Serenade-" + std::to_string(sw.params.N) +
    ...
    Serenade_Opportunistic_Proof serenade_opt_s(sw.params.N, Ouroboros, sw.params.Q_bound); /* create a Serena scheduler */
