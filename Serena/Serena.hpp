...
public:
    ...
    Serena(int p):\
    Scheduler(p),  r_matching(p, 0), s_output_matched(p, 0), merged_matching(p, 0), internal_counter(0){};
...
void Serena::arrival_matching_greedy (lws_param_t &g_params, lws_status_t &g_status) {
