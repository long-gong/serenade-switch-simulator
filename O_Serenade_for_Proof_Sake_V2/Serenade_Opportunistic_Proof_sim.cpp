...
int main(int argc, char* argv[]){
    ...
    std::string fn = "../results/SO_Serenade-" + std::to_string(sw.params.N) +
    ...
    E_Serenade_ serenade_opt_s(sw.params.N, Ouroboros, BSIT, sw.params.Q_bound, sw.params.frequency); /* create a Serena scheduler */
